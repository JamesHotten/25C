...
%.o: ../%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	...
	"C:/ti/ccs2010/ccs/tools/compiler/ti-cgt-armllvm_4.0.2.LTS/bin/tiarmclang.exe" -c @"device.opt"  -march=thumbv6m -mcpu=cortex-m0plus -mfloat-abi=soft -mlittle-endian -mthumb -O0 -I"C:/Users/JamesHotten/Desktop/code/25C/OLED_Software_IIC" -I"C:/Users/JamesHotten/Desktop/code/25C/OLED_Software_IIC/OLED" -I"C:/Users/JamesHotten/Desktop/code/25C/OLED_Software_IIC/Debug" -I"C:/ti/mspm0_sdk_2_04_00_06/source/third_party/CMSIS/Core/Include" -I"C:/ti/mspm0_sdk_2_04_00_06/source" -gdwarf-3 -MMD -MP -MF"$(basename $(<F)).d_raw" -MT"$(@)"  $(GEN_OPTS__FLAG) -o"$@" "$<"
...
build-2098127233: ../oled.syscfg
	...
	"C:/ti/sysconfig_1.22.0/sysconfig_cli.bat" --script "C:/Users/JamesHotten/Desktop/code/25C/OLED_Software_IIC/oled.syscfg" -o "." -s "C:/ti/mspm0_sdk_2_04_00_06/.metadata/product.json" --compiler ticlang
	@echo 'Finished building: "$<"'
	@echo ' '
