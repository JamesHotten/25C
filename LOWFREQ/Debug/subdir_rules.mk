...
build-325876399: ../timx_timer_mode_capture_duty_and_period.syscfg
	...
	"C:/ti/sysconfig_1.22.0/sysconfig_cli.bat" --script "C:/Users/JamesHotten/Desktop/code/25C/LOWFREQ/timx_timer_mode_capture_duty_and_period.syscfg" -o "." -s "C:/ti/mspm0_sdk_2_04_00_06/.metadata/product.json" --compiler gcc
	@echo 'Finished building: "$<"'
	@echo ' '
