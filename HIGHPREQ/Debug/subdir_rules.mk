...
timx_timer_mode_capture_duty_and_period.o: ../timx_timer_mode_capture_duty_and_period.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Building file: "$<"'
	@echo 'Invoking: Arm Compiler'
	"C:/ti/ccs2010/ccs/tools/compiler/ti-cgt-armllvm_4.0.2.LTS/bin/tiarmclang.exe" -c @"device.opt"  -march=thumbv6m -mcpu=cortex-m0plus -mfloat-abi=soft -mlittle-endian -mthumb -O0 -I"C:/Users/JamesHotten/Desktop/code/25C/HIGHPREQ" -I"C:/Users/JamesHotten/Desktop/code/25C/HIGHPREQ/Debug" -I"C:/ti/mspm0_sdk_2_04_00_06/source/third_party/CMSIS/DSP/Include" -I"C:/ti/mspm0_sdk_2_04_00_06/source/third_party/CMSIS/Core/Include" -I"C:/ti/mspm0_sdk_2_04_00_06/source" -gdwarf-3 -MMD -MP -MF"$(basename $(<F)).d_raw" -MT"$(basename\ $(<F)).o"  $(GEN_OPTS__FLAG) -o"$@" "$<"
	@echo 'Finished building: "$<"'
	@echo ' '
...
build-483169409: ../timx_timer_mode_capture_duty_and_period.syscfg
	...
	"C:/ti/sysconfig_1.22.0/sysconfig_cli.bat" --script "C:/Users/JamesHotten/Desktop/code/25C/HIGHPREQ/timx_timer_mode_capture_duty_and_period.syscfg" -o "." -s "C:/ti/mspm0_sdk_2_04_00_06/.metadata/product.json" --compiler ticlang
	@echo 'Finished building: "$<"'
	@echo ' '
